...
export const IconBed = () => (
    <svg width={xny + 8} height={xny + 2} fill="#000000" viewBox="0 0 512 512" id="Layer_1" enable-background="new 0 0 512 512" xmlns="http://www.w3.org/2000/svg">
...
export const IconWhatsapp = () => (
    <div style={{ paddingTop: 2 }}>
        <svg width={xny + 16} height={xny + 16} viewBox="-19.2 -19.2 230.40 230.40" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000000" strokeWidth="0.0019200000000000003"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
...
export const IconRepeat = () => (
    <svg width={xny + 10} height={xny + 10} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
...
export const IconDownload = () => (
    <svg width={xny + 8} height={xny + 4} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M8 22.0002H16C18.8284 22.0002 20.2426 22.0002 21.1213 21.1215C22 20.2429 22 18.8286 22 16.0002V15.0002C22 12.1718 22 10.7576 21.1213 9.8789C20.3529 9.11051 19.175 9.01406 17 9.00195M7 9.00195C4.82497 9.01406 3.64706 9.11051 2.87868 9.87889C2 10.7576 2 12.1718 2 15.0002L2 16.0002C2 18.8286 2 20.2429 2.87868 21.1215C3.17848 21.4213 3.54062 21.6188 4 21.749" stroke="#000000" stroke-width="1.5" stroke-linecap="round"></path> <path d="M12 2L12 15M12 15L9 11.5M12 15L15 11.5" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
)
...
export const IconMail = () => (
    <svg width={xny + 12} height={xny + 12} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#000000">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title></title> <g id="Complete"> <g id="mail"> <g> <polyline fill="none" points="4 8.2 12 14.1 20 8.2" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></polyline> <rect fill="none" height="14" rx="2" ry="2" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="18" x="3" y="6.5"></rect> </g> </g> </g> </g></svg>
...
export const IconRulerMeters = ({ flag = 1 }) => (
    <svg width={xny + 2} height={xny - 2} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="#000000" transform={`matrix(${flag}, 0, 0, 1, 0, 0)`}>
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <g id="ruler" clip-path="url(#clipRuler)">
